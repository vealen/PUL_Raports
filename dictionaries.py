...
""", False, 'L_ENERG_NLS', ],
             'Leśny Materiał Podstawowy': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.FOREST_FUNC_CD AS [Funkcja lasu], [skrocony_opis-taks].ot
FROM F_ARODES INNER JOIN ([skrocony_opis-taks] RIGHT JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM
...
ORDER BY F_ARODES.ORDER_KEY;
""", False, 'BUP', ],
             'Uprawy pochodne': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.FOREST_FUNC_CD AS [Funkcja lasu], [skrocony_opis-taks].ot
FROM F_ARODES INNER JOIN ([skrocony_opis-taks] RIGHT JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM
WHERE (((F_ARODES.TEMP_ADRESS_FOREST) Like ?) AND ((F_SUBAREA.SUBAREA_INFO) Like '%UPR_POCH%') AND ((F_ARODES.TEMP_ACT_ADRESS)=True))
ORDER BY F_ARODES.ORDER_KEY;
""", False, 'UP', ],
             'Gospodarstwa specjalne': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje różne], F_SUBAREA.SITE_TYPE_CD AS [Typ siedliskowy lasu], F_SUBAREA.MOISTURY_CD AS Uwilgotnienie, F_AROD_PROT_SITE.PROT_SITE_CD AS [Siedlisko przyrodnicze]
...
ORDER BY F_ARODES.ORDER_KEY;
""", False, 'UEK', ],
             'Strefy ochrony': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.FOREST_FUNC_CD AS [Funkcja lasu], [skrocony_opis-taks].ot, F_SUBAREA.SILVICULTURE_CD
FROM F_ARODES INNER JOIN ([skrocony_opis-taks] RIGHT JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM
...
ORDER BY F_ARODES.ORDER_KEY;
""", False, 'POZ_OSOB', ],
             'Ekosystemy referencyjne istniejące': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.FOREST_FUNC_CD AS [Funkcja lasu], [skrocony_opis-taks].ot, F_SUBAREA.SILVICULTURE_CD FROM F_ARODES INNER JOIN ([skrocony_opis-taks] RIGHT JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM WHERE (((F_ARODES.TEMP_ADRESS_FOREST) Like ?) AND ((F_SUBAREA.SUBAREA_INFO) Like '%EKO_REF%' And (F_SUBAREA.SUBAREA_INFO) Not Like '%prop.EKO_REF%') AND ((F_ARODES.TEMP_ACT_ADRESS)=True)) ORDER BY F_ARODES.ORDER_KEY;""", False, 'EKO_REF_IST', ],
             'Ekosystemy referencyjne proponowane': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj pow], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.FOREST_FUNC_CD AS [Funkcja lasu], [skrocony_opis-taks].ot, F_SUBAREA.SILVICULTURE_CD FROM F_ARODES INNER JOIN ([skrocony_opis-taks] RIGHT JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM WHERE (((F_ARODES.TEMP_ADRESS_FOREST) Like ?) AND ((F_SUBAREA.SUBAREA_INFO) Like '%prop.EKO_REF%') AND ((F_ARODES.TEMP_ACT_ADRESS)=True)) ORDER BY F_ARODES.ORDER_KEY;""", False, 'EKO_REF_PROP', ],
             'Siedliska przyrodnicze': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST, F_SUBAREA.AREA_TYPE_CD, F_AROD_PROT_SITE.PROT_SITE_CD, F_AROD_PROT_SITE.PROT_SITE_STATE, F_SUBAREA.SUB_AREA, F_AROD_PROT_SITE.PROT_SITE_AREA, F_AROD_PROT_SITE.LOCATION_CD, F_SUBAREA.SUBAREA_INFO, F_SUBAREA.SILVICULTURE_CD, F_SUBAREA.FOREST_FUNC_CD
...
ORDER BY F_ARODES.ORDER_KEY, F_ARODES.ORDER_KEY;
""", False, 'ZREB_IST', ],
             'KO, KDO': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.SUB_AREA AS Pow, F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.AREA_TYPE_CD AS [Rodzaj powierzchni], F_SUBAREA.STAND_STRUCT_CD
FROM F_ARODES INNER JOIN F_SUBAREA ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM
...
""", False, 'DST_BRK_WSK', ],
             'Przebudowa A': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.SUB_AREA AS Pow, [skrocony_opis-taks].ot AS [Skrócony opis taksacyjny], F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], [MEASURE_CD] & ' (' & [LARGE_TIMBER_PERC] &'%)' AS Zabieg, F_SUBAREA.RECONSTR_CD, [skrocony_opis-taks].SPECIES_CD AS Wyr1
...
ORDER BY F_ARODES.ORDER_KEY;
""", False, 'PRZEB_A', ],
             'Przebudowa B': ["""SELECT F_ARODES.TEMP_ADRESS_FOREST AS [Adres leśny], F_SUBAREA.SUB_AREA AS Pow, [skrocony_opis-taks].ot AS [Skrócony opis taksacyjny], F_AROD_CUE.MEASURE_CD AS Wskazanie, F_AROD_CUE.CUTTING_AREA AS [Pow wskazania], F_SUBAREA.SUBAREA_INFO AS [Informacje dodatkowe], F_SUBAREA.RECONSTR_CD AS [Kod przebudowy], [skrocony_opis-taks].SPECIES_CD
FROM (F_ARODES INNER JOIN ([skrocony_opis-taks] INNER JOIN F_SUBAREA ON [skrocony_opis-taks].ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) ON F_ARODES.ARODES_INT_NUM = F_SUBAREA.ARODES_INT_NUM) INNER JOIN F_AROD_CUE ON F_SUBAREA.ARODES_INT_NUM = F_AROD_CUE.ARODES_INT_NUM
